...
| BUSI | ResNet18 pretrained | Yes | Yes | Yes | 15 | 0.8390 | 0.8365 | selected BUSI baseline; malignant remains the hardest class |
...
| Pneumonia | ResNet18 pretrained | Yes | Yes | Yes | 10 | 0.8782 | 0.8732 | selected Pneumonia baseline; NORMAL recall improved but false positives remain |
...
- With pretrained weights, BUSI reached weighted F1 0.8365 and Pneumonia reached weighted F1 0.8732 on the test sets. These models were selected as the classifiers for the counterfactual evaluation.
