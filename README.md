...
- [CFProto method documentation](results/final_configs/cfproto_encoder_method_documentation.md)
- [Goyal-CVE method documentation](results/final_configs/goyal_cve_method_documentation.md)
- [SEDC-T method documentation](results/final_configs/sedc_t_method_documentation.md)
- [DVCE method documentation](results/final_configs/dvce_method_documentation.md)
- [DVCE Cone Projection workflow](results/final_configs/dvce_cone_projection.md)
